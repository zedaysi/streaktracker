...
Stores all streaks, ongoing ones and those that ended. Shows simple graphs for each
Data stored locally so is device-specific but there is a copy-json-to-clipboard export and json import if you need to move the data around
